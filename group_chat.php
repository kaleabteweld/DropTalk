...
<head>
    ...
    <title>Group Chat [ <?php $main->get_user_groups_name([$_SESSION["user_id"],$_GET["id"]]); print_r($main->get_sql_raw());  ?> ]</title>
...
<body class="bg-dark" id="body">
    ...
    <div class="settings" style="display: none;">
        ...
        <nav class="Nav">
            ...
            <?php
                    ...
                    if (isset($_GET)) {
                        ...
                        echo "<a href=\"../DropTalk/backEnd/add_user_to_group.php?id={$id}\" class=\"log_out\">
                        <img src=\"../DropTalk/img/main/addapk.png\" class=\"log_out\">
                    </a>";

                        }else{

                            echo "<a href=\"../DropTalk/backEnd/remove_user_from_group.php?id={$id}\" class=\"log_out\">
        ...
        <div id="logup">
            ...
            <button id="login" class="ac">About Group</button>
        ...
        <div class="members" style="display: none;">
                ...
                <div id="root">
                    ...
                    <?php
                        ...
                        //echo $_GET["id"];
                        $phml->list_all_group_members($_GET["id"]);
        ...
        <div class="main">
            ...
            <img src="<?php $main->get_user_groups_porfile_pic($_GET["id"]); print_r($main->get_sql_raw()); ?>" class="G_pic">

            <div class="nonrmal">
                <p class="name"><?php $main->get_user_groups_name([$_SESSION["user_id"],$_GET["id"]]); print_r($main->get_sql_raw());  ?></p>
                <p class="bio"><?php $main->get_user_groups_bio([$_SESSION["user_id"],$_GET["id"]]); print_r($main->get_sql_raw());  ?></p>
            </div>

            <div class="admin" style="display: <?php $main->group_cheak_if_admin([$_SESSION["user_id"],$_GET["id"]]);if($main->get_sql_raw()[0] == 'TRUE'){echo "flex";}if($main->get_sql_raw()[0] != 'TRUE'){echo "none";}?>;">

                <p class="into"> Admin</p>

                <form class="form" action="../DropTalk/backEnd/edit_group.php?id=<?php echo (string) $_GET["id"]; ?>"  method="post">
                    ...
                    <div class="form-group">
                        ...
                        " placeholder="rename" d="<?php $main->get_user_groups_name([$_SESSION["user_id"],$_GET["id"]]); print_r($main->get_sql_raw());  ?>">
                    ...
                    <div class="form-group">
                        <input type="text" name = "bio" class="form-control bio" placeholder="rename bio" d="<?php $main->get_user_groups_bio([$_SESSION["user_id"],$_GET["id"]]); print_r($main->get_sql_raw());  ?>">
                        <div class="invalid-feedback">
                            <p>
                                check your Bio
                            </p>
                ...
                <a href="../DropTalk/backEnd/remove_group.php?id=<?php echo urlencode($_GET["id"]);?>"" class="btn btn-danger reCh">delet channel</a>
    ...
    <nav id="head" class="navbar navbar-dark bg-dark">
        ...
        <a href="/DropTalk/main.php?page=Group">
            <img src="../DropTalk//img/main/back-tb.png" id="back">
        </a>
        <div class="but">
            
            <img src="<?php $main->get_user_groups_porfile_pic($_GET["id"]); print_r($main->get_sql_raw()); ?>" id="G_pic">
            <div id="text"> 
                <p id="G_name"> <?php $main->get_user_groups_name([$_SESSION["user_id"],$_GET["id"]]); print_r($main->get_sql_raw());  ?></p>

                <p id="G_len"><?php $main->get_groups_members_len($_GET["id"]); print_r($main->get_sql_raw()); ?> members</p>
            </div>
    ...
    <nav id="consoil" class="navbar navbar-dark bg-dark" style="display:<?php if (isset($_GET)) {if (isset($_GET['new'])) {echo "none";}else{ echo "flex";}}?>;">
